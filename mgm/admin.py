...
class MemberInvitationAdmin(admin.ModelAdmin):
    list_display = ('creation_date', 'key', 'invitator', 'credits_new_member', 'credits_invitator', 'redeem_on_signup', 'expiration_date')
    list_filter = ('creation_date', 'expiration_date', 'redeem_on_signup')
